...
class PasienController extends Controller
{
    ...
    {
        return view('pasien/tambahpasienform', [
            'dokter' => Dokter::all()
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pasien/pasien-rekammedis', [
            'pasien' => $pasien,
            'rekam' => $rekam,
            'dokter' => Dokter::all(),
            'obat' => Obat::all()
    ...
    public function destroy(Pasien $pasien)
    {
        ...
        $rekam->delete();
        return redirect('/pasien/index')->with('success', 'Data terhapus');
    }
    public function antrianpasien()
    {
        $data = Rekam::where('diagnosa', null)->get();
        return view('pasien/antrian-pasien', [
            'datarekam' => $data
        ]);
    }
    ...
    {
        $data = Dokter::all();
        return view('pasien/pasien-lama', [
            'dokter' => $data
        ]);
    }
