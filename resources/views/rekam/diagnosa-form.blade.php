        ...
        <form action="/rekam/diagnosatools/update/{{ $diagnosa->id }}" method="POST">
            ...
            <div class="form-group row mt-2">
                ...
                <div class="col-sm-5">
                    ...
                    <textarea readonly type="text" value="{{ $diagnosa->keluhan}}" name="RekamMedis" class="form-control" cols="30" rows="5">{{ $diagnosa->keluhan }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="diagnosa" placeholder="Diagnosa.."
                        required value="{{ $diagnosa->diagnosa }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select name="obat" id="" class="form-control">
                        ...
                        @foreach ($obat as $o)
                            <option value="{{ $o->id }}">{{ $o->namaobat . ' (Sisa stok: ' . $o->stok . ')' }}
                            </option>
                        @endforeach
                    </select>
                </div>
