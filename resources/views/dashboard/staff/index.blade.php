...
@section('dashboard')
    ...
    @include('dashboard.staff.component.table')
@endsection
...
<script>
    ...
    $(".userstaff-delete").on('click', function() {
        id = $(this).data("delstaffid");
        userName = $(this).data("deluserstaff");
        $("#delete-data-name").text('Apakah Anda yakin ingin menghapus ' + userName + '?');
    });
    // submit delete function
    $(".submit-delete").on('click', function() {
        // window.location.href='/settings/userstaffs/delete/'+id
    });
</script>
@endsection