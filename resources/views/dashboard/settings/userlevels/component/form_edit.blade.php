<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{route('userlevels-edit-submit',['id'=>$dataDetail->id ])}}">
            @csrf
            <div class="form-group">
                <label for="levelname">Level Name</label>
                <input @error('levelname') style="border:1px solid #ff0000;" @enderror name="levelname" type="text"
                    value="{{ old('levelname') == null ? $dataDetail->levelname : old('levelname') }}" class="form-control"
                    id="levelname" placeholder="levelname">
                @error('levelname')
