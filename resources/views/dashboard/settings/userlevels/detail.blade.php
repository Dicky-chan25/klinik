                    ...
                    <tbody>
                        @foreach ($getMenu as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input read-onclick" id="status" type="checkbox" name="status"
                                            data-readvalue="{{ $item->read }}"
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input create-onclick" id="status" type="checkbox" name="status"
                                            data-createvalue="{{ $item->create }}"
                                            data-accessid="{{ $item->accessId }}"
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input edit-onclick" id="status" type="checkbox" name="status"
                                            data-editvalue="{{ $item->edit }}"
                                            data-accessid="{{ $item->accessId }}"
                                ...
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input delete-onclick" id="status" type="checkbox" name="status"
                                            data-deletevalue="{{ $item->delete }}"
                                            data-accessid="{{ $item->accessId }}"
