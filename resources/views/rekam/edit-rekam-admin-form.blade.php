    ...
    <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select name="obat" id="" class="form-control">
                    ...
                    @foreach ($obat as $o)
                    <option value="{{ $o->id }}" {{ $rekam->obat != '' ?? $o->obat->namaobat == $o->namaobat->id ? 'selected' : ''}}> {{ $o->namaobat. " |Stok: " .$o->stok }}</option>
                    {{-- <option value="{{ $o->id }}">
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="/pasien/pasien-rekammedis/edit/{{ $id_pasien }}" class="btn btn-warning">Kembali</a>
            </div>
        </div>
        </form>
