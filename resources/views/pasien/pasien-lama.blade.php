...
<body id="page-top" onload="initClock()">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="/welcome"><img src="{{ asset('') }}assets/img/icon.png" class="brand-image img-circle elevation-3 bg-white"
    ...
    <section class="page-section portfolio" id="lama">
        <div class="container">
            ...
            <form action="/pasien/cekpasienlama" method="POST">
                @csrf
                <!--------------------------------------------------------Nama----------------------------------------------------------------------------------->
