...
<body id="page-top" onload="initClock()">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('') }}assets/img/icon.png"
                    class="brand-image img-circle elevation-3 bg-white" width="55" ;height="55"></a>
            <a class="navbar-brand" href="#page-top">
                <h3>Praktik Mandiri <br>dr. Asep </h3>
            </a>
    ...
    <header class="masthead bg-info text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5 img-circle elevation-3 bg-white" src="{{ asset('') }}assets/img/icon.png"
                alt="..." />
            <!-- Masthead Heading-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">TANGERANG</p>
        </div>
    </header>
    <!--------------------------------------------------------Bagian Isi Konten----------------------------------------------------------------------------------->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                        ...
                        <img class="img-fluid" src="{{ asset('') }}assets/img/dalam2.jpg" alt="..." />
                    </div>
                </div>
                <!-- Portfolio Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                        ...
                        <img class="img-fluid" src="{{ asset('') }}assets/img/dalam1.jpg" alt="..." />
                    </div>
                </div>
                <!-- Portfolio Item 3-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
                        ...
                        <img class="img-fluid" src="{{ asset('') }}assets/img/luar1.jpg" alt="..." />
                    </div>
                </div>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <div class="google-map"><iframe frameborder="0" style="border:0" width="100%" height="250" src=<?php echo
                    $mappp; ?> allowfullscreen=""></iframe></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        ...
                        <br />
                        Kecamatan Pakuhaji, Kabupaten Tangerang - Indonesia
                    </p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="col-lg-4">
                    ...
                    <p class="lead mb-0">
                        Klinik Sehat dibangun sejak tahun 2023 yang berada di kecamatan Pakuhaji Kabupaten Tangerang
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Copyright &copy; Klinik Sehat 2023</small></div>
    </div>
    <!-- Portfolio Modals-->
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <img class="img-fluid rounded mb-5" src="{{ asset('') }}assets/img/dalam2.jpg"
                                    alt="..." />
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="{{ asset('') }}assets/img/dalam1.jpg"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">======</p>
                                <button class="btn btn-primary" data-bs-dismiss="modal">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="{{ asset('') }}assets/img/luar1.jpg"
                                    alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">======</p>
                                <button class="btn btn-primary" data-bs-dismiss="modal">
            ...
            <div
                ...
                <form action="/pasien/store" method="post">
                    ...
                    <div class="modal-body relative p-4">
                        <a href="/pasien/pasien-lama" type="button" class="btn btn-warning">Pasien Lama?</a>
    ...
    <!-- Daftar Pasien Modal -->
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        id="daftarPasienbaru" tabindex="-1" aria-labelledby="daftarPasienbaruLabel" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg relative w-auto pointer-events-none" role="document">
            <div
                class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                <div
                ...
                <form action="/pasien/store" method="post">
                    ...
                    <div class="modal-body relative p-4">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-5 col-form-label"><a href="/pasien/pasien-lama" type="button"
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm">
                                <input type="text" class="form-control" name="Alamat" placeholder="Alamat" required
                                    oninvalid="this.setCustomValidity('alamat masih kosong')"
                                    oninput="setCustomValidity('')">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm">
                                <input type="date" class="form-control" name="Lahir" placeholder="Lahir" required
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm">
                                <input type="text" class="form-control" id="nonik" name="NIK" placeholder="NIK" required
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm">
                                ...
                                <textarea type="text" name="RekamMedis" class="form-control" cols="30" rows="5"
                                    ...
                                    oninvalid="this.setCustomValidity('jelaskan dahulu...')"
                            ...
                            <div class="col-sm">
                                <select name="doktor" class="form-control " required
                                    ...
                                    <option {{ $row->jadwal->jadwalpraktek == 'LIBUR' ? 'disabled' : ''}} {{
                                        $row->jadwal->jadwalpraktek == 'CUTI' ? 'disabled' : ''}} value="{{ $row->id
                                        }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            <img src="{{ asset('') }}assets/img/icon.png" style=”float:left; width="55" ;height="55"
                                ” />Klinik Sehat
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p class="h3">Nomor Antrian : <span class="text-primary">{{ Session::has('nomorAntrian') ?
                                Session::get('nomorAntrian') : '' }}</span>
                        </p>
                        <p class="h3">Atas Nama : <span class="text-primary">{{ Session::has('nama') ?
                                Session::get('nama') : '' }}</span>
                        </p>
                        <p>Daftar pada jam : <span class="text-primary">{{ Session::has('timestamps') ?
                                Session::get('timestamps') : '' }}</span>
                        </p>
                    </div>
                    <div class="modal-footer">
                        <p>Tanggal : <span class="text-primary">{{ Session::has('tanggaldaftar') ?
                                Session::get('tanggaldaftar') : '' }}</span>
                        </p>
