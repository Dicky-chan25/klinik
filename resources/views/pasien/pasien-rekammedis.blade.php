    ...
    @endif
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="/pasien/index" class="btn btn-danger">Kembali</a>
            </div>
        </div>
        {{-- </form> --}}
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-flush"  id="example1" id="products-list">
                <thead class="thead-dark">
                    <tr>
                        <th>No</th>
                        <th width="20px">Tanggal Periksa</th>
                        <th>Layanan</th>
                        <th>Keluhan</th>
                        <th>Dokter</th>
                        <th>Diagnosa</th>
                    ...
                    @foreach ($rekam as $row)
                        <tr>
                            ...
                            <td>{{ $row->pinggang ?? "-" }} Cm</td>
                                ...
                                -----------------------------------------------------------------------------------* />
                            <td class="text-sm">
                                <a href="/pasien/{{ $row->id_pasien }}/editrekam/{{ $row->id }}" class="btn btn-warning"
                                    ...
                                    -----------------------------------------------------------------------------------* />
                                    <a href="/rekam/delete/{{ $row->id }}" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="bi bi-trash"></i></a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                ...
                                required oninvalid="this.setCustomValidity('Pilih Obatnya dahulu..')"
                                    ...
                                    @foreach ($obat as $o)
                                        <option value="{{ $o->id }}">
                                            {{ $o->namaobat . ' (Sisa stok: ' . $o->stok . ')' }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
