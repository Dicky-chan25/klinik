<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <div class="">
            <h5 class="text-primary m-2">Form Laborat Pasien</h5>
        </div>
        <div class="">
    ...
    <div class="card-body">
        ...
        <div class="d-flex">
            <div class="col-lg-6">
                ...
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-4 col-form-label">Kode Laborat</label>
                    <div class="col-sm-8">
            ...
            <div class="col-lg-6">
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-4 col-form-label">Nama Laborat</label>
                    <div class="col-sm-8">
