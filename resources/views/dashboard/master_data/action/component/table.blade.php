...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Semua Tindakan</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">

            @include('dashboard.master_data.action.component.modal_delete')
            @include('dashboard.master_data.action.component.modal_filter')

            <div class="d-flex justify-content-between my-2">
                @if ($access->create == 1)
                    <a href="{{ route('tindakan-create') }}" class="text-light">
                ...
                <div class="d-flex">
                    ...
                    @include('dashboard.master_data.action.component.search')
                </div>
            </div>
            ...
            <table class="table" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($access->edit == 1)
                            <a href="{{route('tindakan-edit',['id'=>$aaItem->id ])}}" class="btn btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            @endif
                            @if ($access->delete == 1)
                            <a class="btn btn-danger data-delete" href="#" data-target="#deleteData" data-toggle="modal"
                                data-delid="{{$aaItem->id}}" data-delname="{{$aaItem->title}}">
